    ...
    columns: [
      {
        ...
        links: [
          ...
          { id: 'rings-engagement', label: 'טבעות אירוסין', href: '/rings/engagement-rings' },
          { id: 'rings-diamond', label: 'טבעות יהלומים', href: '/rings/diamond-rings' },
          { id: 'rings-wedding', label: 'טבעות נישואין', href: '/rings/wedding-rings' },
          { id: 'rings-gold', label: 'טבעות זהב', href: '/rings/gold-rings' },
          {
            id: 'rings-colored',
            label: 'טבעות עם יהלומים צבעוניים',
            href: '/rings/colored-diamond-rings',
          },
        ],
      },
    ...
    columns: [
      {
        ...
        links: [
          ...
          { id: 'earrings-diamond', label: 'עגילי יהלום', href: '/earrings/diamond-earrings' },
          { id: 'earrings-hoop', label: 'עגילי חישוק', href: '/earrings/hoop-earrings' },
          { id: 'earrings-drop', label: 'עגילים תלויים', href: '/earrings/drop-earrings' },
          { id: 'earrings-stud', label: 'עגילים צמודים', href: '/earrings/stud-earrings' },
        ],
      },
    ...
    columns: [
      {
        ...
        links: [
          ...
          { id: 'necklaces-gold', label: 'שרשראות זהב', href: '/necklaces/gold-necklaces' },
          {
            id: 'necklaces-diamond',
            label: 'שרשראות יהלומים',
            href: '/necklaces/diamond-necklaces',
          },
          { id: 'necklaces-pendants', label: 'תליונים', href: '/necklaces/pendant-necklaces' },
          { id: 'necklaces-name', label: 'שרשראות שם', href: '/necklaces/name-necklaces' },
          { id: 'necklaces-photo', label: 'שרשראות תמונה', href: '/necklaces/photo-necklaces' },
        ],
      },
    ...
    columns: [
      {
        ...
        links: [
          ...
          { id: 'bracelets-tennis', label: 'צמידי טניס', href: '/bracelets/tennis-bracelets' },
          { id: 'bracelets-diamond', label: 'צמידי יהלומים', href: '/bracelets/diamond-bracelets' },
          { id: 'bracelets-gold', label: 'צמידי זהב', href: '/bracelets/gold-bracelets' },
          {
            id: 'bracelets-delicate',
            label: 'צמידים עדינים',
            href: '/bracelets/delicate-bracelets',
          },
          { id: 'bracelets-link', label: 'צמידי חוליות', href: '/bracelets/link-bracelets' },
        ],
      },
    ...
    columns: [
      {
        ...
        links: [
          ...
          { id: 'sets-ring-earrings', label: 'טבעת ועגילים', href: '/sets/ring-earring-sets' },
          {
            id: 'sets-necklace-earrings',
            label: 'שרשרת ועגילים',
            href: '/sets/necklace-earring-sets',
          },
          { id: 'sets-bridal', label: 'סטים לכלה', href: '/sets/bridal-sets' },
          { id: 'sets-gift', label: 'סטי מתנה', href: '/sets/gift-sets' },
        ],
      },
